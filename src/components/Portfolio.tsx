...
const PROJECTS = [
  { title:"Dr. Alexander Oburoh — Professional Email & DNS Setup", cat:"fullstack", url:"https://alexanderoburoh.com", img:"/alexanderoburoh.png", alt:"Professional domain email and DNS infrastructure setup for Dr. Alexander Oburoh by Great Emman-Wori", desc:"Configured professional domain email for Dr. Alexander Oburoh using Truehost Workplace Email, Cloudflare DNS, and Vercel-hosted website infrastructure.", tags:["Cloudflare","DNS","Truehost","Vercel","Email Hosting","SPF","DKIM","DMARC","Deliverability"], badge:"Full-Stack" },
